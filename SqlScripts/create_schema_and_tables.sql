...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`bag_of_words` (
  ...
  PRIMARY KEY (`id`),
  INDEX `bagOfWords_into_rawTextExcerptLocation_idx` (`rawTextExcerptLocationId` ASC),
  CONSTRAINT `bagOfWords_into_rawTextExcerptLocation`
...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`pre_process_step` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` ENUM('lower', 'upper', 'removeCharacterPunctuation', 'stemming', 'lemmatize', 'tokenize', 'nGram') NOT NULL,
  `tokenizeType` ENUM('eachSpaceEndLine', 'eachCharacter', 'eachPunctuation') NULL,
  `stemmingType` ENUM('porter') NULL,
  `nGramType` ENUM('nGram', 'nSkipGram') NULL,
  `nGramParameterN` INT UNSIGNED NULL,
  `nGramParameterSkip` INT UNSIGNED NULL,
  `regexRule` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`pre_process_step_chain_node` (
  ...
  `bagType` ENUM('bagOfTexts', 'bagOfSentences', 'bagOfWords', 'bagOfGramsSets') NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`word_locations` (
  ...
  `rawTextExcerptLocationId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`wordId`, `rawTextExcerptLocationId`),
  INDEX `wordLocations_into_rawTextLocation_idx` (`rawTextExcerptLocationId` ASC),
  CONSTRAINT `wordLocations_into_rawTextExcerptLocation`
    FOREIGN KEY (`rawTextExcerptLocationId`)
    REFERENCES `plagiarism_detection`.`raw_text_excerpt_location` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
...
-- -----------------------------------------------------
-- Table `plagiarism_detection`.`bag_of_texts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`bag_of_texts` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `textCollectionMetaId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `bagOfTexts_into_textCollectionMeta_idx` (`textCollectionMetaId` ASC),
  CONSTRAINT `bagOfTexts_into_textCollectionMeta`
    FOREIGN KEY (`textCollectionMetaId`)
    REFERENCES `plagiarism_detection`.`text_collection_meta` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `plagiarism_detection`.`bag_of_sentences`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`bag_of_sentences` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `rawTextExcerptLocationId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `bagOfWord_into_rawTextExcerptLocation_idx` (`rawTextExcerptLocationId` ASC),
  CONSTRAINT `bagOfSentences_into_rawTextExcerptLocationId`
    FOREIGN KEY (`rawTextExcerptLocationId`)
    REFERENCES `plagiarism_detection`.`raw_text_excerpt_location` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
...
-- -----------------------------------------------------
-- Table `plagiarism_detection`.`bag_of_n_grams`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`bag_of_n_grams` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `rawTextExcerptLocationId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `bagOfNGrams_into_rawTextExcerptLocation_idx` (`rawTextExcerptLocationId` ASC),
  CONSTRAINT `bagOfNGrams_into_rawTextExcerptLocation`
    FOREIGN KEY (`rawTextExcerptLocationId`)
    REFERENCES `plagiarism_detection`.`raw_text_excerpt_location` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
...
-- -----------------------------------------------------
-- Table `plagiarism_detection`.`bag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`bag` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `preProcessStepChainNodeId` INT UNSIGNED NOT NULL,
  `bagOfTextsId` INT UNSIGNED NOT NULL,
  `bagOfSentencesId` INT UNSIGNED NOT NULL,
  `bagOfWordsId` INT UNSIGNED NOT NULL,
  `bagOfNGramId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `bag_into_preProcessStepChainNode_idx` (`preProcessStepChainNodeId` ASC),
  INDEX `bag_into_bagOfWords_idx` (`bagOfWordsId` ASC),
  INDEX `bag_into_bagOfNGrams_idx` (`bagOfNGramId` ASC),
  INDEX `bag_into_bagOfSentences_idx` (`bagOfSentencesId` ASC),
  INDEX `bag_into_bagOfTexts_idx` (`bagOfTextsId` ASC),
  CONSTRAINT `bag_into_preProcessStepChainNode`
    FOREIGN KEY (`preProcessStepChainNodeId`)
    REFERENCES `plagiarism_detection`.`pre_process_step_chain_node` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `bag_into_bagOfWords`
    FOREIGN KEY (`bagOfWordsId`)
    REFERENCES `plagiarism_detection`.`bag_of_words` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `bag_into_bagOfTexts`
    FOREIGN KEY (`bagOfTextsId`)
    REFERENCES `plagiarism_detection`.`bag_of_texts` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `bag_into_bagOfSentences`
    FOREIGN KEY (`bagOfSentencesId`)
    REFERENCES `plagiarism_detection`.`bag_of_sentences` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `bag_into_bagOfNGrams`
    FOREIGN KEY (`bagOfNGramId`)
    REFERENCES `plagiarism_detection`.`bag_of_n_grams` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`sentence` (
  ...
  `rawTextExcerptLocationId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `sentence_into_bagOfSentences_idx` (`bagOfSentencesId` ASC),
  INDEX `sentence_into_rawTextExcerptLocation_idx` (`rawTextExcerptLocationId` ASC),
  CONSTRAINT `sentence_into_bagOfSentences`
    FOREIGN KEY (`bagOfSentencesId`)
    REFERENCES `plagiarism_detection`.`bag_of_sentences` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `plagiarism_detection`.`text`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`text` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `bagOfTextsId` INT UNSIGNED NOT NULL,
  `text` MEDIUMTEXT NOT NULL,
  `rawTextExcerptLocationId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `text_into_rawTextExcerptLocationId_idx` (`rawTextExcerptLocationId` ASC),
  INDEX `text_into_bagOfTexts_idx` (`bagOfTextsId` ASC),
  CONSTRAINT `text_into_rawTextExcerptLocationId`
    FOREIGN KEY (`rawTextExcerptLocationId`)
    REFERENCES `plagiarism_detection`.`raw_text_excerpt_location` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `text_into_bagOfTexts`
    FOREIGN KEY (`bagOfTextsId`)
    REFERENCES `plagiarism_detection`.`bag_of_texts` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`n_gram` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `bagOfNGramsId` INT UNSIGNED NOT NULL,
  `occurence` INT UNSIGNED NOT NULL,
  `commaSeparatedGrams` TEXT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `nGram_into_bagOfNGrams_idx` (`bagOfNGramsId` ASC),
  CONSTRAINT `nGram_into_bagOfNGrams`
    FOREIGN KEY (`bagOfNGramsId`)
    REFERENCES `plagiarism_detection`.`bag_of_n_grams` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `plagiarism_detection`.`n_gram_locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`n_gram_locations` (
  `nGramId` INT UNSIGNED NOT NULL,
  `rawTextExcerptLocationId` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`nGramId`, `rawTextExcerptLocationId`),
  INDEX `nGramLocations_into_rawTextExcerptLocation_idx` (`rawTextExcerptLocationId` ASC),
  CONSTRAINT `nGramLocations_into_rawTextExcerptLocation`
    FOREIGN KEY (`rawTextExcerptLocationId`)
    REFERENCES `plagiarism_detection`.`raw_text_excerpt_location` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `nGramLocations_into_nGram`
    FOREIGN KEY (`nGramId`)
    REFERENCES `plagiarism_detection`.`n_gram` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
