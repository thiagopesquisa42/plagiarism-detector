...
CREATE TABLE IF NOT EXISTS `plagiarism_detection`.`seed_attributes` (
  ...
  `plagiarismClass` ENUM('none', 'direct', 'obfuscatedRandom', 'obfuscatedTranslation', 'obfuscatedSummary') NULL,
  `percentualInDetection` DOUBLE NULL,
  `cosine` DOUBLE NULL,
  `dice` DOUBLE NULL,
